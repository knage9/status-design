...
export declare class DashboardService {
    ...
    getExecutorStats(startDate?: string, endDate?: string, serviceType?: string, executorId?: number): Promise<{
        executor: {
            id: any;
            name: any;
            email: any;
    ...
    getManagerDashboard(userId: number): Promise<{
        stats: {
    ...
    getMasterDashboard(userId: number): Promise<{
        executorStage: {
            totalTasks: number;
            doneTasks: number;
            timeSeconds: number;
    ...
    getExecutorDashboard(userId: number): Promise<{
        activeWorkOrders: {
            workOrderId: number;
            orderNumber: string;
            customerName: string;
    ...
    updateExecutorPayment(assignmentId: number, paidAmount: number, isPaid: boolean): Promise<{
        id: number;
